...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PG14     ------> I2C1_SCL
    */
    HAL_GPIO_DeInit(I2C1_SDA_BMS_GPIO_Port, I2C1_SDA_BMS_Pin);

    HAL_GPIO_DeInit(I2C1_SCL_BMS_GPIO_Port, I2C1_SCL_BMS_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SPI1_SCK_UI_Pin|SPI1_MOSI_UI_Pin);
