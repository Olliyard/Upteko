...
#define OPEN 110
#define HOLD 5
#define WIND_IN_SLOW 20 // 20 is the correct ~32 sec     12.50%
#define WIND_IN_FAST 40 // 40 is the correct             37.00%
...
#define RELEASE_MED 40  // 40 is the correct    37.00%
#define RELEASE_FAST 85 // 85 is the correct    93.75%    Although 65 is probably the fastest we can go bc of the speed of arduino interrupt
...
//  //////Serial.println(RC_PWM_stored);
  ...
  case 12: // Release rope   1100 // CORRECT!! 12 = 1100. DID THIS TO CONTROL WITH SWITCH, remember to revert!
    //Serial.print("Release with: ");
    //Serial.print(in_encoder_byte);
    //Serial.print(" vs ");
    //Serial.println(rev_at_startup);    //  -40->-29           -52              0                   24
    if (in_encoder_byte < (rev_at_startup + 13))
    {                     // if we are after 12 and before 130
      pwm = RELEASE_FAST; // in the middle
      //////Serial.println("fast");
      //////Serial.println(rev_at_startup - (motor_rev_out_target/2));
    }
    ...
    //else if (in_encoder_byte < (rev_at_startup))
